...
import NewTournament from '../../components/newTournamentForm';
...
export default function DashboardPage() {
    ...
    const [showForm, setShowForm] = useState(false); // affiche form
    ...
    return (
        <div className="min-h-screen p-8 bg-[#1a1b20] text-white">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="mt-6 rounded-lg bg-gradient-to-r from-red-400/20 via-transparent to-transparent p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h2 className="text-2xl font-bold">Bienvenu LM Ram</h2>
                ...
                {/* affiche composant NewTournament if showForm true */}
                {showForm ? (
                    <NewTournament onClose={handleCloseForm} />
                ) : (
